...
tr_dataset = NpyDataset("/mnt/sda/minkyukim/sam_dataset/coco_npy_train_dataset_1024image__")
...
parser.add_argument(
    ...
    "--tr_npy_path",
    type=str,
    default="/mnt/sda/minkyukim/sam_dataset/coco_npy_train_dataset_1024image__",
