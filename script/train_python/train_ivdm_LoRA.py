...
model_save_path = "../../../../../../mnt/sda/minkyukim/pth/sam-tutorial_ivdm_LoRA"
...
def main():
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        torch.save(sam_model.state_dict(), join(model_save_path, f"medsam_LoRA_{epoch}.pth"))
        ## save the best model
        if epoch_loss < best_loss:
            best_loss = epoch_loss

            torch.save(sam_model.state_dict(), join(model_save_path, "medsam_LoRA_best.pth"))
